...
<form class="l-flow woocommerce-EditAccountForm edit-account max-w-[360px]"
	  action=""
	  method="post"
	...
	<fieldset class="l-flow" data-flow-size="xs">
		<legend class="my-2 text-lg font-bold"><?php esc_html_e( 'Password change', 'woocommerce' ); ?></legend>

		<p class="c-form-row | l-flow" data-flow-size="xs">
			<label
				for="password_current"><?php esc_html_e( 'Current password (leave blank to leave unchanged)', 'woocommerce' ); ?></label>
			<span><input type="password" name="password_current" id="password_current" autocomplete="off"/></span>
		</p>
		<p class="c-form-row | l-flow" data-flow-size="xs">
			<label
				for="password_1"><?php esc_html_e( 'New password (leave blank to leave unchanged)', 'woocommerce' ); ?></label>
			<span><input type="password" name="password_1" id="password_1" autocomplete="off"/></span>
		</p>
		<p class="c-form-row | l-flow" data-flow-size="xs">
			<label for="password_2"><?php esc_html_e( 'Confirm new password', 'woocommerce' ); ?></label>
			<span><input type="password" name="password_2" id="password_2" autocomplete="off"/></span>
		</p>
	</fieldset>
	<div class="clear"></div>
