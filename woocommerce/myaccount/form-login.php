...
<div class="flex flex-wrap justify-center gap-[200px]" id="customer_login">
	...
	<div class="basis-[320px]">
		...
		<form class="l-flow | l-login" method="post">
			...
			<button type="submit" class="c-button woocommerce-button button woocommerce-form-login__submit"
					data-button-type="filled" data-button-width="full" name="login" value="Zaloguj się">Zaloguj się
			</button>
			<button type="button"
		...
		<div class="basis-[320px]">
			...
			<form method="post"
				...
				<div class="l-encourage-creation | l-flow" data-flow-size="md">
					<button class="c-button js-show-register-form" data-button-type="filled" data-button-width="full">
						Załóż konto
					</button>
